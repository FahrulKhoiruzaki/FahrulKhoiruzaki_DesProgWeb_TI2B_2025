        ...
        if (mysqli_query($koneksi, $query_anggota)) {
            if (!empty($_POST['password'])) {
                ...
                if (mysqli_query($koneksi, $query_user)) {
                    ...
                    pesan(
                        'warning',
                        "Data Anggota Berhasil Diubah, Tetapi Password Gagal Diubah Karena: " . mysqli_error($koneksi)
                    );
                }
            } else {
                ...
                if (mysqli_query($koneksi, $query_user)) {
                    ...
                    pesan(
                        'warning',
                        "Data Anggota Berhasil Diubah, Tetapi Username Gagal Diubah Karena: " . mysqli_error($koneksi)
                    );
                }
            }
        } else {
